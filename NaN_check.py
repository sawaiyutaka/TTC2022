...
all_1st = pd.read_table("/Volumes/Pegasus32R8/TTC/2022csv_outcome/TTC2022_1st_outcome_Imp.csv", delimiter=",", low_memory=False)
print(all_1st)
...
sr = sr[sr < NUM_0F_NAN]  # 100人未満だと580項目, 150人未満だと630項目, 200人未満で679項目
