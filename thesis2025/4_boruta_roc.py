...
df = pd.read_table("/Volumes/Pegasus32R8/TTC/2025thesis/X_NAN_under_5percent_and_Y.csv", delimiter=",")
...
df.to_csv("/Volumes/Pegasus32R8/TTC/2025thesis/df4boruta.csv")
...
df_concat.to_csv("/Volumes/Pegasus32R8/TTC/2025thesis/ocs2ple_w_imp.csv")
