...
df.to_csv("/Volumes/Pegasus32R8/TTC/2022domain/x_t_y.csv")

"""

df = pd.read_table("/Volumes/Pegasus32R8/TTC/2022domain/x_t_y.csv", delimiter=",")
df = df.set_index("SAMPLENUMBER")
...
df_3rd = pd.concat([df_upper, df_lower])
print(df_3rd)
df_3rd.to_csv("/Volumes/Pegasus32R8/TTC/2022domain/upper_lower_combined.csv")
